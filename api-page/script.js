document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "RYOFC UI");
        setContent('wm', 'textContent', `© 2025 ${settings.apiSettings.creator}. All rights reserved.` || "© 2025 RYOFC. All rights reserved.");
        setContent('header', 'textContent', settings.name || "RYOFC UI");
        setContent('name', 'textContent', settings.name || "RYOFC UI");
